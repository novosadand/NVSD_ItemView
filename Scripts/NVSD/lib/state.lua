...
state.loop_bar_height = 0             -- 0 when loop off, LOOP_BAR_HEIGHT when on
state.loop_bar_y = 0                  -- Y position of loop bar
state.loop_hovered = nil              -- nil, "start", "end", or "body"
state.loop_start_time = 0             -- source-time of loop start
state.loop_end_time = 0               -- source-time of loop end
state.loop_bar_dragging = nil         -- nil, "start", "end", or "body"
state.loop_drag_start_x = 0           -- mouse X at drag start
state.loop_drag_start_val = 0         -- source-time value at drag start
state.loop_drag_body_end = 0          -- end value at body drag start
