...
local HELP_SECTIONS = {
  ...
  },
  {
    ...
    lines = {
      ...
      "",
      "## Loop Bar",
      "When Loop is ON, a loop bar appears below the ruler with draggable triangle markers.",
      "- Drag the left marker to set loop start, right marker to set loop end",
      "- These define which portion of the source audio loops (REAPER's Section mode)",
      "- When markers span the full source, the section is removed (normal loop)",
      "- Alt+click the Loop button to remove the section",
    },
  },
  {
  ...
  },
  {
    ...
    lines = {
      ...
      "- Use the loop bar below the ruler to set a custom loop region. Drag triangle markers to define which part of the source repeats when looped. The Loop button shows '§' when a section is active",
      "",
