...
local HELP_SECTIONS = {
  ...
  },
  {
    ...
    lines = {
      ...
      {key = "Alt+drag", desc = "Slide both markers (preserve length)"},
  ...
  },
  {
    ...
    lines = {
      ...
      {key = "Clear", desc = "Reset pitch, playrate, WARP, markers"},
  ...
  },
  {
    ...
    lines = {
      ...
      "",
      "Right-click warp bar for context menu.",
  ...
  },
  {
    ...
    lines = {
      ...
      {key = "Shift+click", desc = "Insert node on segment"},
      {key = "Alt+click", desc = "Delete node"},
      {key = "Alt+drag segment", desc = "Adjust tension"},
  ...
  },
  {
    ...
    lines = {
      "## Info Bar",
      "- Filename (click for Media Explorer), sample rate, BPM",
      "- CUE button for embedded WAV cue markers (M to toggle)",
      "- Ghost markers button in bottom bar (G to toggle, experimental)",
      ...
      "- Drag to reorder, right-click for context menu",
    },
  },
  {
    ...
    lines = {
      ...
      "- Right-click buttons for context menu",
    },
  },
  {
    ...
    lines = {
      ...
      {key = "G", desc = "Ghost markers (experimental)"},
      ...
      "Double-click any knob/slider to reset.",
    },
  },
  {
    header = "Tips",
